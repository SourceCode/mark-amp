...
TEST_CASE("V27 P08: Code context count", "[v27][p08]") { REQUIRE(v27_code_context_count() == 4); }
TEST_CASE("V27 P08: Syntax palette values", "[v27][p08]") {
    REQUIRE(V27SyntaxPaletteTokens::kEditorFontSize >= V27SyntaxPaletteTokens::kEditorFontSize);
