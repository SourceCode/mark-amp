# Phase 09: Dependency Injection And Service Composition Rationalization

## Goal
Adopt consistent dependency injection and remove hidden service locator patterns.

## Why This Phase Now
Service construction is distributed and can obscure runtime dependencies, making tests and reasoning harder.

## Primary Target Files/Areas
- \/Users\/ryanrentfro\/code\/markamp\/src\/app\n- \/Users\/ryanrentfro\/code\/markamp\/src\/core\n- \/Users\/ryanrentfro\/code\/markamp\/src\/ui\/MainFrame.cpp\n- \/Users\/ryanrentfro\/code\/markamp\/tests\/unit

## Tasks (22)
1. Run a focused architecture inventory for dependency injection and composition roots and capture current ownership gaps.
2. Identify the top coupling points and rank them by change-risk and blast radius.
3. Define explicit module responsibilities and non-responsibilities for dependency injection and composition roots.
...
7. Split oversized classes/functions in dependency injection and composition roots into cohesive components.
...
10. Standardize naming and folder placement for dependency injection and composition roots artifacts.
