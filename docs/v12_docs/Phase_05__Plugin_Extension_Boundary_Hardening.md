# Phase 05: Plugin Extension Boundary Hardening

## Goal
Enforce strict plugin contracts, capability boundaries, and lifecycle safety.

## Why This Phase Now
Plugin and extension paths are feature-rich; contract drift and broad context access can erode maintainability and safety.

## Primary Target Files/Areas
- \/Users\/ryanrentfro\/code\/markamp\/src\/core\/PluginManager.cpp\n- \/Users\/ryanrentfro\/code\/markamp\/src\/core\/PluginContext.h\n- \/Users\/ryanrentfro\/code\/markamp\/src\/core\/ExtensionSandbox.h\n- \/Users\/ryanrentfro\/code\/markamp\/src\/core\/ExtensionManagement.h

## Tasks (22)
1. Run a focused architecture inventory for plugin and extension boundaries and capture current ownership gaps.
2. Identify the top coupling points and rank them by change-risk and blast radius.
3. Define explicit module responsibilities and non-responsibilities for plugin and extension boundaries.
...
7. Split oversized classes/functions in plugin and extension boundaries into cohesive components.
...
10. Standardize naming and folder placement for plugin and extension boundaries artifacts.
