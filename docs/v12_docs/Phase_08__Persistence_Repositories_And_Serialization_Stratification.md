# Phase 08: Persistence Repositories And Serialization Stratification

## Goal
Separate persistence adapters from domain logic using repository and serialization boundaries.

## Why This Phase Now
Serialization and storage responsibilities appear intermixed with business rules in several subsystems.

## Primary Target Files/Areas
- \/Users\/ryanrentfro\/code\/markamp\/src\/core\/BlockDatabase.cpp\n- \/Users\/ryanrentfro\/code\/markamp\/src\/canvas\/BoardSerializer.h\n- \/Users\/ryanrentfro\/code\/markamp\/src\/core\/av\n- \/Users\/ryanrentfro\/code\/markamp\/src\/core\/NotebookSerializer.h

## Tasks (22)
1. Run a focused architecture inventory for persistence and serialization boundaries and capture current ownership gaps.
2. Identify the top coupling points and rank them by change-risk and blast radius.
3. Define explicit module responsibilities and non-responsibilities for persistence and serialization boundaries.
...
7. Split oversized classes/functions in persistence and serialization boundaries into cohesive components.
...
10. Standardize naming and folder placement for persistence and serialization boundaries artifacts.
