# Phase 17: Security Privacy And Runtime Policy Separation

## Goal
Isolate security and privacy concerns into auditable, testable policy modules.

## Why This Phase Now
Security-sensitive features should be centralized so policy changes are explicit and uniformly enforced.

## Primary Target Files/Areas
- \/Users\/ryanrentfro\/code\/markamp\/src\/core\/EncryptionService.h\n- \/Users\/ryanrentfro\/code\/markamp\/src\/core\/RuntimePolicy.h\n- \/Users\/ryanrentfro\/code\/markamp\/src\/core\/ExtensionSandbox.h\n- \/Users\/ryanrentfro\/code\/markamp\/src\/core\/PrivacyManager.h

## Tasks (22)
1. Run a focused architecture inventory for security and privacy policy boundaries and capture current ownership gaps.
2. Identify the top coupling points and rank them by change-risk and blast radius.
3. Define explicit module responsibilities and non-responsibilities for security and privacy policy boundaries.
...
7. Split oversized classes/functions in security and privacy policy boundaries into cohesive components.
...
10. Standardize naming and folder placement for security and privacy policy boundaries artifacts.
