# Phase 04: Configuration Scopes And Settings Domain Cleanup

## Goal
Isolate settings concerns into cohesive domains with strict ownership and migration paths.

## Why This Phase Now
Config and settings logic spans many call sites and needs stronger separation between defaults, overrides, migration, and UI binding.
...
## Tasks (22)
1. Run a focused architecture inventory for configuration ownership and settings isolation and capture current ownership gaps.
2. Identify the top coupling points and rank them by change-risk and blast radius.
3. Define explicit module responsibilities and non-responsibilities for configuration ownership and settings isolation.
...
7. Split oversized classes/functions in configuration ownership and settings isolation into cohesive components.
...
10. Standardize naming and folder placement for configuration ownership and settings isolation artifacts.
