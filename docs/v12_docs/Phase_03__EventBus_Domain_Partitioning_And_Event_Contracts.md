# Phase 03: EventBus Domain Partitioning And Event Contracts

## Goal
Partition event traffic by bounded context and enforce typed, versioned event contracts.

## Why This Phase Now
A large shared event surface increases accidental coupling and makes change impact difficult to predict.

## Primary Target Files/Areas
- \/Users\/ryanrentfro\/code\/markamp\/src\/core\/Events.h\n- \/Users\/ryanrentfro\/code\/markamp\/src\/core\/EventBus.h\n- \/Users\/ryanrentfro\/code\/markamp\/src\/core\/EventBus.cpp\n- \/Users\/ryanrentfro\/code\/markamp\/tests\/unit

## Tasks (22)
1. Run a focused architecture inventory for event domain partitioning and capture current ownership gaps.
2. Identify the top coupling points and rank them by change-risk and blast radius.
3. Define explicit module responsibilities and non-responsibilities for event domain partitioning.
...
7. Split oversized classes/functions in event domain partitioning into cohesive components.
...
10. Standardize naming and folder placement for event domain partitioning artifacts.
