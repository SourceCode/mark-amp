# Phase 14: Build Target Modularization And CMake Governance

## Goal
Reorganize build targets to mirror architectural modules and enforce boundaries in CMake.

## Why This Phase Now
Architecture and build graph should align so violations are prevented by build structure, not only conventions.

## Primary Target Files/Areas
- \/Users\/ryanrentfro\/code\/markamp\/CMakeLists.txt\n- \/Users\/ryanrentfro\/code\/markamp\/cmake\n- \/Users\/ryanrentfro\/code\/markamp\/src\n- \/Users\/ryanrentfro\/code\/markamp\/tests

## Tasks (22)
1. Run a focused architecture inventory for build graph modularization and capture current ownership gaps.
2. Identify the top coupling points and rank them by change-risk and blast radius.
3. Define explicit module responsibilities and non-responsibilities for build graph modularization.
...
7. Split oversized classes/functions in build graph modularization into cohesive components.
...
10. Standardize naming and folder placement for build graph modularization artifacts.
