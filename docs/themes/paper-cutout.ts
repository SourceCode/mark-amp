...
export const paperCutout: Theme = {
    colors: {
    accent: '#2563eb',
    border: '#111827',
    chromeBg: 'linear-gradient(180deg, #ffffff 0%, #fef3c7 100%)',
    chromeText: '#111827',
    error: '#dc2626',
    primary: '#f97316',
    primaryText: '#ffffff',
    ...
    text: '#111827',
    textMuted: '#6b7280',
    wallpaper: 'linear-gradient(135deg, #fff7ed 0%, #fefce8 45%, #eff6ff 100%)',
    warning: '#eab308',
    windowBg: '#fffdf7',
    windowBorder: '#111827'
},
    description: 'Layered cardstock, tactile shadows, and playful editorial UI.',
    ...
    radius: '10px',
    shadow: '0 10px 0 rgba(17,24,39,0.35), 0 22px 40px rgba(0,0,0,0.18)',
    titleBarHeight: '34px'
},
};
