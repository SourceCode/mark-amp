...
export const industrialWarning: Theme = {
    colors: {
    accent: '#ef4444',
    border: '#facc15',
    chromeBg: '#020617',
    ...
    text: '#e5e7eb',
    textMuted: '#9ca3af',
    wallpaper: 'linear-gradient(135deg, #020617 0%, #111827 100%)',
    warning: '#facc15',
    windowBg: '#0f172a',
    windowBorder: '#facc15'
},
    description: 'Hazard stripes, machinery panels, and factory control UI.',
    ...
    radius: '2px',
    shadow: '0 10px 0 #facc15, 0 22px 40px rgba(0,0,0,0.75)',
    titleBarHeight: '34px'
},
};
