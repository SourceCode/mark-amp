...
export const bladeRunnerNeon: Theme = {
    colors: {
    accent: '#38bdf8',
    border: 'rgba(56, 189, 248, 0.35)',
    chromeBg: 'linear-gradient(180deg, rgba(15,23,42,0.95), rgba(2,6,23,0.95))',
    chromeText: '#e5f6ff',
    error: '#ef4444',
    primary: '#ec4899',
    primaryText: '#020617',
    ...
    surfaceHighlight: 'rgba(236, 72, 153, 0.18)',
    text: '#e5f6ff',
    textMuted: 'rgba(229, 246, 255, 0.55)',
    wallpaper: 'radial-gradient(circle at 20% 30%, rgba(236,72,153,0.35) 0%, transparent 55%), radial-gradient(circle at 80% 40%, rgba(56,189,248,0.25) 0%, transparent 60%), linear-gradient(180deg, #020617 0%, #040a1a 50%, #020617 100%)',
    warning: '#facc15',
    windowBg: 'rgba(2, 6, 23, 0.9)',
    windowBorder: 'rgba(236, 72, 153, 0.4)'
},
    description: 'Rain-soaked neon, noir shadows, and futuristic city glow.',
    editor: createDefaultEditorTheme({
        background: 'rgba(2, 6, 23, 0.9)',
        caret: '#38bdf8',
        comment: 'rgba(229, 246, 255, 0.55)',
        gutter: 'rgba(2, 6, 23, 0.9)',
        keyword: '#ec4899',
    ...
    radius: '6px',
    shadow: '0 22px 55px rgba(2,6,23,0.9)',
    titleBarHeight: '38px'
},
};
