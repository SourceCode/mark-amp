...
export const snesClassic: Theme = {
    colors: {
    accent: '#22c55e',
    border: '#9ca3af',
    chromeBg: 'linear-gradient(180deg, #ede9e3 0%, #d6d3ce 100%)',
    chromeText: '#374151',
    error: '#ef4444',
    primary: '#7c3aed',
    primaryText: '#ffffff',
    ...
    success: '#22c55e',
    surface: '#ede9e3',
    surfaceHighlight: '#f5f3ef',
    text: '#374151',
    textMuted: '#6b7280',
    wallpaper: 'linear-gradient(135deg, #d6d3ce 0%, #e5e3df 45%, #cfcac3 100%)',
    warning: '#eab308',
    windowBg: '#e5e3df',
    windowBorder: '#9ca3af'
},
    description: 'Soft plastic greys, pastel buttons, and 16-bit console nostalgia.',
    ...
    radius: '6px',
    shadow: '0 6px 0 #9ca3af, 0 10px 18px rgba(0,0,0,0.25)',
    titleBarHeight: '32px'
},
};
