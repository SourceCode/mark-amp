...
export const windowsXP: Theme = {
    colors: {
        ...
        chromeText: '#000000',
        error: '#FF0000',
        primary: '#245DDA', // Luna Blue
        primaryText: '#FFFFFF',
        secondary: '#D0C6B0', // Beige-ish secondary
        success: '#008000',
        surface: '#FFFFFF',
        surfaceHighlight: '#316AC5',
        text: '#000000',
        textMuted: '#808080',
        wallpaper: '#3B6EA5', // Default Blue
        warning: '#FFFF00',
        windowBg: '#FFFFFF',
        windowBorder: '#00138C',
    },
    description: 'Blissful hills and Luna blue integration.',
