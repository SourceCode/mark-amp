...
export const elementEther: Theme = {
    colors: {
    accent: '#22d3ee',
    border: 'rgba(167,139,250,0.55)',
    chromeBg: 'linear-gradient(180deg, rgba(49,46,129,0.95) 0%, rgba(2,6,23,0.95) 100%)',
    chromeText: '#ede9fe',
    error: '#fb7185',
    primary: '#a78bfa',
    primaryText: '#020617',
    ...
    surfaceHighlight: 'rgba(167,139,250,0.3)',
    text: '#ede9fe',
    textMuted: 'rgba(237,233,254,0.55)',
    wallpaper: 'radial-gradient(circle at 50% 30%, rgba(167,139,250,0.45) 0%, transparent 60%), radial-gradient(circle at 80% 70%, rgba(34,211,238,0.35) 0%, transparent 60%), linear-gradient(135deg, #020617 0%, #020617 100%)',
    warning: '#facc15',
    windowBg: 'rgba(2, 6, 23, 0.88)',
    windowBorder: 'rgba(167,139,250,0.55)'
},
    description: 'Cosmic void, astral glow, and metaphysical depth.',
    ...
    radius: '20px',
    shadow: '0 34px 80px rgba(167,139,250,0.5)',
    titleBarHeight: '44px'
},
};
