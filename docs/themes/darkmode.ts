...
export const darkmode: Theme = {
    colors: {
        ...
        wallpaper: 'radial-gradient(at 0% 0%, hsla(253,16%,7%,1) 0, transparent 50%), radial-gradient(at 50% 0%, hsla(225,39%,30%,1) 0, transparent 50%), radial-gradient(at 100% 0%, hsla(339,49%,30%,1) 0, transparent 50%), linear-gradient(135deg, #1e1b4b 0%, #4c1d95 30%, #be185d 70%, #ea580c 100%)',
        wallpaperOverlay: 'url(#noise)',
        warning: '#f59e0b',
        windowBg: 'rgba(17, 24, 39, 0.85)',
        windowBorder: 'rgba(255, 255, 255, 0.1)'
    },
    description: 'The default modern dark aesthetic.',
    editor: createDefaultEditorTheme({
        background: 'rgba(17, 24, 39, 0.85)',
        caret: '#8b5cf6',
        comment: 'rgba(255, 255, 255, 0.5)',
        gutter: 'rgba(17, 24, 39, 0.85)',
        keyword: '#db2777',
