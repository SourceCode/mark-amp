...
export const akiraNeoTokyo: Theme = {
    colors: {
    accent: '#ef4444',
    border: '#dc2626',
    chromeBg: 'linear-gradient(180deg, #1a0202 0%, #0b0b0b 100%)',
    chromeText: '#fef2f2',
    error: '#ef4444',
    primary: '#dc2626',
    primaryText: '#ffffff',
    secondary: '#1f2933',
    success: '#22c55e',
    surface: 'rgba(26, 2, 2, 0.85)',
    surfaceHighlight: 'rgba(239, 68, 68, 0.18)',
    text: '#fef2f2',
    textMuted: 'rgba(254, 242, 242, 0.55)',
    wallpaper: 'radial-gradient(circle at 70% 20%, rgba(239,68,68,0.35) 0%, transparent 55%), radial-gradient(circle at 20% 80%, rgba(220,38,38,0.25) 0%, transparent 60%), linear-gradient(135deg, #050505 0%, #0b0b0b 50%, #120202 100%)',
    warning: '#facc15',
    windowBg: 'rgba(5, 5, 5, 0.92)',
    windowBorder: '#dc2626'
},
    description: 'High-contrast cyberpunk red, industrial blacks, and anime dystopia.',
    editor: createDefaultEditorTheme({
        background: 'rgba(5, 5, 5, 0.92)',
        caret: '#ef4444',
        comment: 'rgba(254, 242, 242, 0.55)',
        gutter: 'rgba(5, 5, 5, 0.92)',
        keyword: '#dc2626',
        line: 'rgba(254, 242, 242, 0.55)',
        number: '#ef4444',
        selection: 'rgba(239, 68, 68, 0.18)',
        selectionText: '#fef2f2',
        string: '#22c55e',
        text: '#fef2f2'
}),
    elevation: {
    ...
    typography: {
        ...
        fontFamily: '"Akira Expanded", "Oswald", "Inter", sans-serif',
    ...
    radius: '2px',
    shadow: '0 18px 40px rgba(220,38,38,0.45)',
    titleBarHeight: '36px'
},
};
