...
export const liquidMetal: Theme = {
    ...
    chromeBg: 'linear-gradient(180deg, rgba(71,85,105,0.95) 0%, rgba(2,6,23,0.95) 100%)',
    chromeText: '#e5e7eb',
    error: '#ef4444',
    primary: '#94a3b8',
    primaryText: '#020617',
    ...
    surfaceHighlight: 'rgba(148,163,184,0.25)',
    text: '#e5e7eb',
    textMuted: 'rgba(229,231,235,0.55)',
    wallpaper: 'linear-gradient(135deg, #020617 0%, #0f172a 50%, #020617 100%)',
    warning: '#facc15',
    windowBg: 'rgba(2, 6, 23, 0.88)',
    windowBorder: 'rgba(148,163,184,0.45)'
},
    description: 'Mercury-like surfaces with cold industrial sheen.',
    editor: createDefaultEditorTheme({
        background: 'rgba(2, 6, 23, 0.88)',
        caret: '#38bdf8',
        comment: 'rgba(229,231,235,0.55)',
        gutter: 'rgba(2, 6, 23, 0.88)',
        keyword: '#94a3b8',
        line: 'rgba(229,231,235,0.55)',
        number: '#ef4444',
    ...
    radius: '10px',
    shadow: '0 26px 60px rgba(148,163,184,0.35)',
    titleBarHeight: '38px'
},
};
