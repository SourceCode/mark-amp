...
export const eInkNotebook: Theme = {
    colors: {
    accent: '#374151',
    border: '#1f2937',
    chromeBg: '#f5f5f5',
    ...
    text: '#1f2937',
    textMuted: '#6b7280',
    wallpaper: 'linear-gradient(135deg, #fafafa 0%, #f5f5f5 100%)',
    warning: '#92400e',
    windowBg: '#ffffff',
    windowBorder: '#1f2937'
},
    description: 'Ultra-minimal grayscale, paper texture, and distraction-free focus.',
