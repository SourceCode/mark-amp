...
export const translucentSlime: Theme = {
    colors: {
    accent: '#4ade80',
    border: 'rgba(132, 204, 22, 0.6)',
    chromeBg: 'linear-gradient(180deg, rgba(20,30,10,0.95) 0%, rgba(2,6,23,0.95) 100%)',
    chromeText: '#ecfccb',
    error: '#fb7185',
    primary: '#84cc16',
    primaryText: '#020617',
    secondary: '#14532d',
    success: '#4ade80',
    surface: 'rgba(20, 83, 45, 0.75)',
    surfaceHighlight: 'rgba(132, 204, 22, 0.3)',
    text: '#ecfccb',
    textMuted: 'rgba(236,252,203,0.55)',
    wallpaper: 'radial-gradient(circle at 30% 20%, rgba(132,204,22,0.45) 0%, transparent 55%), radial-gradient(circle at 75% 70%, rgba(34,197,94,0.35) 0%, transparent 60%), linear-gradient(135deg, #020617 0%, #020617 100%)',
    warning: '#facc15',
    windowBg: 'rgba(2, 6, 23, 0.78)',
    windowBorder: 'rgba(132, 204, 22, 0.6)'
},
    description: 'Gelatinous translucency, toxic glow, and oozing UI surfaces.',
    editor: createDefaultEditorTheme({
        background: 'rgba(2, 6, 23, 0.78)',
        caret: '#4ade80',
        comment: 'rgba(236,252,203,0.55)',
        gutter: 'rgba(2, 6, 23, 0.78)',
        keyword: '#84cc16',
        line: 'rgba(236,252,203,0.55)',
        number: '#fb7185',
        selection: 'rgba(132, 204, 22, 0.3)',
        selectionText: '#ecfccb',
        string: '#4ade80',
        text: '#ecfccb'
}),
    elevation: {
    ...
    radius: '26px',
    shadow: '0 34px 80px rgba(132,204,22,0.55), inset 0 2px 0 rgba(255,255,255,0.12)',
    titleBarHeight: '44px'
},
};
