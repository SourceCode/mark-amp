...
export const seasonWinter: Theme = {
    colors: {
    accent: '#7dd3fc',
    border: 'rgba(186,230,253,0.45)',
    chromeBg: 'linear-gradient(180deg, rgba(30,41,59,0.95) 0%, rgba(2,6,23,0.95) 100%)',
    chromeText: '#e0f2fe',
    error: '#fb7185',
    primary: '#38bdf8',
    primaryText: '#020617',
    ...
    surfaceHighlight: 'rgba(186,230,253,0.25)',
    text: '#e0f2fe',
    textMuted: 'rgba(224,242,254,0.55)',
    wallpaper: 'radial-gradient(circle at 50% 20%, rgba(186,230,253,0.45) 0%, transparent 60%), linear-gradient(135deg, #020617 0%, #020617 100%)',
    warning: '#facc15',
    windowBg: 'rgba(2, 6, 23, 0.88)',
    windowBorder: 'rgba(186,230,253,0.45)'
},
    description: 'Frosted glass, cold air, and quiet snowfall.',
    editor: createDefaultEditorTheme({
        ...
        number: '#fb7185',
        selection: 'rgba(186,230,253,0.25)',
    ...
    radius: '22px',
    shadow: '0 34px 80px rgba(186,230,253,0.4)',
    titleBarHeight: '44px'
},
};
