...
export const memphisMilano: Theme = {
    colors: {
    accent: '#22d3ee',
    border: '#111827',
    chromeBg: 'linear-gradient(90deg, #facc15, #ec4899, #22d3ee)',
    chromeText: '#111827',
    error: '#ef4444',
    primary: '#ec4899',
    primaryText: '#ffffff',
    ...
    text: '#111827',
    textMuted: '#6b7280',
    wallpaper: 'linear-gradient(135deg, #fffbeb 0%, #ffffff 100%), repeating-linear-gradient(45deg, rgba(0,0,0,0.08) 0 2px, transparent 2px 14px)',
    warning: '#facc15',
    windowBg: '#ffffff',
    windowBorder: '#111827'
},
    description: 'Playful geometry, bold colors, and postmodern 80s design chaos.',
    ...
    typography: {
        ...
        fontFamily: '"Poppins", "Futura", system-ui, sans-serif',
    ...
    radius: '0px',
    shadow: '8px 8px 0 #111827, 16px 16px 0 #22d3ee',
    titleBarHeight: '36px'
},
};
