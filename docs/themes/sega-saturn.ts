...
export const segaSaturn: Theme = {
    colors: {
    accent: '#8b5cf6',
    border: '#9ca3af',
    chromeBg: 'linear-gradient(180deg, #f3f4f6 0%, #d1d5db 100%)',
    chromeText: '#1f2937',
    error: '#ef4444',
    primary: '#6d28d9',
    primaryText: '#ffffff',
    ...
    text: '#1f2937',
    textMuted: '#6b7280',
    wallpaper: 'linear-gradient(135deg, #e5e7eb 0%, #d1d5db 45%, #c7cad1 100%)',
    warning: '#eab308',
    windowBg: '#e5e7eb',
    windowBorder: '#9ca3af'
},
    description: 'Cool greys, soft purples, and clean futuristic 90s console design.',
    ...
    typography: {
        ...
        fontFamily: '"Eurostile", "Orbitron", system-ui, sans-serif',
    ...
    radius: '6px',
    shadow: '0 6px 0 #9ca3af, 0 12px 22px rgba(0,0,0,0.25)',
    titleBarHeight: '32px'
},
};
