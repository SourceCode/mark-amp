...
export const elementFire: Theme = {
    colors: {
    accent: '#ef4444',
    border: '#f97316',
    chromeBg: 'linear-gradient(180deg, #451a03 0%, #1a0502 100%)',
    chromeText: '#fff7ed',
    error: '#ef4444',
    primary: '#f97316',
    primaryText: '#020617',
    ...
    wallpaper: 'radial-gradient(circle at 35% 65%, rgba(249,115,22,0.5) 0%, transparent 60%), linear-gradient(135deg, #020617 0%, #1a0502 100%)',
    warning: '#fb923c',
    windowBg: 'rgba(26, 5, 2, 0.9)',
    windowBorder: '#f97316'
},
    description: 'Volcanic glow, molten gradients, and raw kinetic energy.',
    editor: createDefaultEditorTheme({
        background: 'rgba(26, 5, 2, 0.9)',
        caret: '#ef4444',
        comment: 'rgba(255,247,237,0.55)',
        gutter: 'rgba(26, 5, 2, 0.9)',
        keyword: '#f97316',
    ...
    radius: '6px',
    shadow: '0 30px 70px rgba(249,115,22,0.55)',
    titleBarHeight: '36px'
},
};
