# Phase 01: Node Editor Product Spec And Non Negotiables

## Goal
Define product scope, quality bars, and architecture constraints for a reusable multi-domain node editor.

## Prerequisites
- PRODUCT_VISION.md and v10 plan accepted
