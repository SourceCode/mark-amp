/// @file DataCommandProvider.h
/// @brief V9 Phase 48 — 8 data table commands for the command palette.
#pragma once
...
/// Provides 8 data-table-related commands.
class DataCommandProvider
{
public:
    DataCommandProvider() = default;
