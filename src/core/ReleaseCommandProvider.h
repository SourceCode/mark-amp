/// @file ReleaseCommandProvider.h
/// @brief V9 Phase 50 — 8 release commands for the command palette.
#pragma once
...
/// Provides 8 release-related commands.
class ReleaseCommandProvider
{
public:
    ReleaseCommandProvider() = default;
