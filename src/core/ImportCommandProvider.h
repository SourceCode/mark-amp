/// @file ImportCommandProvider.h
/// @brief V9 Phase 42 — Document import commands for command palette.
#pragma once
...
/// Provides 8 import-related commands for the command palette.
class ImportCommandProvider
{
public:
    ImportCommandProvider() = default;
