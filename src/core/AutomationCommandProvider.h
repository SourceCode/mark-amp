/// @file AutomationCommandProvider.h
/// @brief V9 Phase 40 — Automation commands for command palette.
#pragma once
...
/// Provides 8 automation-related commands for the command palette.
class AutomationCommandProvider
{
public:
    AutomationCommandProvider() = default;
