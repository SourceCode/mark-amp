/// @file ActivityCommandProvider.h
/// @brief V9 Phase 39 — Activity commands for command palette.
#pragma once
...
/// Provides 8 activity-related commands for the command palette.
class ActivityCommandProvider
{
public:
    ActivityCommandProvider() = default;
