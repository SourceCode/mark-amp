/// @file PresentationCommandProvider.h
/// @brief V9 Phase 43 — 8 presentation commands for the command palette.
#pragma once
...
/// Provides 8 presentation-related commands.
class PresentationCommandProvider
{
public:
    PresentationCommandProvider() = default;
