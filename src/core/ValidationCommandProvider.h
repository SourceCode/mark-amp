/// @file ValidationCommandProvider.h
/// @brief V9 Phase 49 — 8 validation commands for the command palette.
#pragma once
...
/// Provides 8 validation-related commands.
class ValidationCommandProvider
{
public:
    ValidationCommandProvider() = default;
