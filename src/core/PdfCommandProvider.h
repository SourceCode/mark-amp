/// @file PdfCommandProvider.h
/// @brief V9 Phase 42 — PDF viewer commands for command palette.
#pragma once
...
/// Provides 8 PDF-related commands for the command palette.
class PdfCommandProvider
{
public:
    PdfCommandProvider() = default;
